...
function AddOns({isChecked, handleCheckBox, boxCheck}){
    return(
        <>
        ...
        <div className='info mb:16 lg:flex-col items-center md:flex-col justify-between mt-6 lg:mt-12 md:mt-12'>
            ...
            <div className="add-div flex mb-4 pt-4 pb-4  lg:h-16 md:h-16 border rounded-lg border-solid items-center border-gray-300">
                <input type="checkbox"  className="w-4 mr-4 ml-4"  checked={boxCheck.largerStorage} onChange={() => handleCheckBox('largerStorage')}/>
                <div  className="p-div">
            ...
            <div className="add-div flex pt-4 mb-4 pb-4  lg:h-16 md:h-16 border rounded-lg border-solid items-center border-gray-300">
                <input type="checkbox" className="w-4 mr-4 ml-4" checked={boxCheck.customizableProfile} onChange={() => handleCheckBox('customizableProfile')} />
                <div className="p-div">
