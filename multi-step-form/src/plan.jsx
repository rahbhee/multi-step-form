...
function Plans() {
    return (
        <>
        <h1 className="plan font-bold mt-2 mb-2 pr-24 lg:text-base md:text-base ">Select your plan</h1>
        <p className="plan-p text-gray-500 lg:text-base md:text-base ">You have the option of monthly or yearly billing</p>
        <div className='info lg:flex items-center md:flex justify-between mt-6 lg:mt-16 md:mt-16'>
            <div className="flex pt-4 pb-4 lg:p-0 md:p-0 lg:flex-col md:flex-col lg:pl-4 md:pl-4 lg:pt-6 md:pt-6 border rounded-lg border-solid border-gray-300 lg:w-40 md:w-40 md:mr-4 lg:mr-4 lg:h-48 md:h-48">
                <div  className="mr-4 ml-4 lg:m-0 md:m-0"><img src={arcade}/></div>
                <div className="p-div lg:mt-20 md:mt-20">
